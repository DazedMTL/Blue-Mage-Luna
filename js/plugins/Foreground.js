...
(function () {
  ...
  //  プラグインコマンドを追加定義します。
  //=======================
  PluginManager.registerCommand("Foreground", "RemakeForeground", (args) => {
    var ForegroundName = args.arg1;
    $gameMap._foregroundName = ForegroundName;
  });
