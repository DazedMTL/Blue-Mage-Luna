...
(() => {
  ...
  const param_BattleLogWindowParams = JSON.parse(
    parameters["Battle Log Window Params"] || "{}",
    paramReplace
  );
  ...
  const param_StartMessagesOnLog =
    parameters["Start Messages On Log?"] === "true";
  const param_LogCommand = parameters["Log Command"] || "";
  const param_PastLogWindowParams = JSON.parse(
    parameters["Past Log Window Params"] || "{}",
    paramReplace
  );
  ...
  Window_BattleLog.prototype.fontSize = function () {
    return (
      param_BattleLogWindowParams["Font Size"] || $gameSystem.mainFontSize()
    );
  };

  const _Window_BattleLog_lineHeight = __base(
  ...
  const _Window_BattleLog_resetFontSettings = __base(
    Window_BattleLog.prototype,
    "resetFontSettings"
  );
  ...
  const _Window_BattleLog_waitForEffect =
    Window_BattleLog.prototype.waitForEffect;
  ...
  const _Window_BattleLog_waitForNewLine =
    Window_BattleLog.prototype.waitForNewLine;
  ...
  class Window_PastBattleLog extends Window_Selectable {
    ...
    fontSize() {
      return (
        param_PastLogWindowParams["Font Size"] || $gameSystem.mainFontSize()
      );
    }
  ...
  const _Scene_Battle_closeCommandWindows =
    Scene_Battle.prototype.closeCommandWindows;
