//=============================================================================
// RPGツクールMZ - LL_MenuScreenCustom.js v1.4.1
//-----------------------------------------------------------------------------
// ルルの教会 (Lulu's Church)
...
(() => {
  ...
  Window_MenuHelp.prototype.drawLeftBlock = function () {
    ...
    this.drawText(
      ...
      this.getFontSize() * leftBlockLabel.length,
      y,
      oneThirdWidth * 1.5 - this.getFontSize() * leftBlockLabel.length,
      leftBlockAlign
    );
  };
  ...
  Window_MenuHelp.prototype.drawRightBlock = function () {
    ...
    this.drawText(
      ...
      this.getFontSize() * rightBlockLabel.length + oneThirdWidth * 1.5,
      y,
      oneThirdWidth * 1.5 - this.getFontSize() * rightBlockLabel.length,
      rightBlockAlign
    );
  };
  ...
  Window_MenuHelp.prototype.drawCurrency = function () {
    ...
    if (currencyWindowPosition == "helpWindowRightBottom") {
      ...
      this.drawText(
        ...
        this.getFontSize() * rightBottomBlockLabel.length + oneThirdWidth * 1.5,
        y,
        oneThirdWidth * 1.5 - this.getFontSize() * rightBottomBlockLabel.length,
        rightBottomBlockAlign
      );
    }
  };
