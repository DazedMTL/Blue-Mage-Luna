...
(() => {
  ...
  const pUseMvAnimationFile = toBoolean(
    parameters["useMvAnimationFile"],
    false
  );
...
(function () {
   ...
   * ●継続時間の設定
   */
  const _Sprite_AnimationMV_setupDuration =
    Sprite_AnimationMV.prototype.setupDuration;
   ...
   * ●アニメーションのスプライト作成
   */
  var _Sprite_AnimationMV_createSprites =
    Sprite_AnimationMV.prototype.createSprites;
   ...
   * ●アニメーションセルの更新
   */
  const _Sprite_AnimationMV_updateCellSprite =
    Sprite_AnimationMV.prototype.updateCellSprite;
   ...
   * ●フラッシュや効果音などの制御
   */
  var _Sprite_AnimationMV_processTimingData =
    Sprite_AnimationMV.prototype.processTimingData;
   ...
   * ●対象非表示
   */
  var _Sprite_AnimationMV_startHiding =
    Sprite_AnimationMV.prototype.startHiding;
   ...
   * ●画面のフラッシュ
   */
  var _Sprite_AnimationMV_startScreenFlash =
    Sprite_AnimationMV.prototype.startScreenFlash;
