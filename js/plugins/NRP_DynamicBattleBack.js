...
(function () {
  ...
  const pBattlebackSettingList = parseStruct2(
    parameters["BattlebackSettingList"]
  );
  ...
  Spriteset_Battle.prototype.createBattleback = function () {
    ...
    // 条件に一致する設定を反映
    this._battleBackDynamicSettings = getMatchSettings(
      battleback1Name,
      battleback2Name
    );
  };
  ...
  function getMatchSettings(battleback1Name, battleback2Name) {
    ...
    const battlebackSettings = pBattlebackSettingList.filter(
      (setting) =>
